(()=>{async function t(t){var i=document.getElementById("search-results");let a=document.getElementById("type-filter").value,l=document.getElementById("department-filter").value,n=document.getElementById("year-filter").value;if(t)try{var s=(await $.get("/api/search/"+t)).data;let e=s;a&&(e=e.filter(e=>e.type===a)),l&&(e=e.filter(e=>e.department===l)),(e=n?e.filter(e=>e.schoolYear===n):e).length?i.innerHTML=e.map(e=>{return`
