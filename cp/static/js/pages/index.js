(async()=>{if($(".scroll-link").on("click",function(e){var t=$(this);$("html, body").stop().animate({scrollTop:$(t.attr("href")).offset().top-10},1e3),e.preventDefault()}),AOS.init({once:!0,mirror:!1}),tns({container:".review-slider .owl-carousel",mouseDrag:!0,swipeAngle:!1,controls:!1,loop:!0,nav:!1,responsive:{768:{items:2},1200:{items:3}}}),window.addEventListener("DOMContentLoaded",function(){function e(t){let i=window.countUp.CountUp,a=document.getElementById(t).textContent;document.getElementById(t).textContent=0,setTimeout(()=>{var e=new i(t,a,{duration:3});e.error?console.error(e.error):e.start()},1e3)}e("memberCount"),e("serverCount"),$(".mplayer").css("display",""),setTimeout(()=>{var e=window.UrlHandler.getHash();e&&(e=document.querySelector(`div a[href="${e}"]`))&&e.scrollIntoView({behavior:"smooth"})},1e3)}),"true"===window.UrlHandler.getQuery("uwu")){logger.event("uwu mode activated"),$(".video-section").append(`
    ...
    `);let t=document.querySelector("#videobg"),i=t.querySelector("source"),a=["frierendance.webm","stelle.webm","frierenvibe.webm","chottomate.webm","1.webm","2.webm","robin.mp4"],s=client.cdn+"/static/media/video/bg/";$("#replacebg").on("click",function(){let e;for(;(e=s+a[Math.floor(Math.random()*a.length)])===i.getAttribute("src"););i.setAttribute("src",e),t.load(),t.play()}),$("#fungif_holder").html(`
    <div class="col-6">
...
`);var e=new jPlayerPlaylist({jPlayer:"#jplayer_N",cssSelectorAncestor:"#jp_container_N"},[{title:"Usagi Flap",artist:"Nor",mp3:client.cdn+"/static/media/music/usagi.mp3",poster:client.cdn+"/static/media/aris-dancing.gif"},{title:"Kuru Kuru",artist:"Raphiiel",mp3:client.cdn+"/static/media/music/kurukuru.mp3",poster:client.cdn+"/static/media/kururin.gif"}],{playlistOptions:{enableRemoveControls:!0,autoPlay:!1},supplied:"webm, mp3, wav",smoothPlayBar:!0,keyEnabled:!0,audioFullScreen:!1});$(document).on($.jPlayer.event.pause,e.cssSelector.jPlayer,function(){$(".musicbar").removeClass("animate"),$(".jp-play-me").removeClass("active"),$(".jp-play-me").parent("li").removeClass("active")}),$(document).on($.jPlayer.event.play,e.cssSelector.jPlayer,function(){$(".musicbar").addClass("animate")}),$("#playlist").on("shown.bs.dropdown",function(){$(".mplayer .jp-playlist.open ul").css({left:"auto",right:"-21px",width:"300px"})})}let s=document.getElementById("youtubeplayerModal");s.addEventListener("shown.bs.modal",function(){"true"!==s.getAttribute("data-loaded")&&LoadHandler.check("videojs").then(()=>{let e=document.getElementById("youtubelink");var t=document.createElement("video");t.id="youtubevidplayer",t.classList.add("video-js","vjs-cosmos","vjs-16-9"),t.setAttribute("controls",""),t.setAttribute("preload","lazy"),t.setAttribute("data-setup",'{ "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "https://www.youtube.com/watch?v=zoEtcR5EW08"}], "youtube": { "customVars": { "wmode": "transparent" } } }'),document.getElementById("ytbvidholder").appendChild(t);let i=videojs("youtubevidplayer");function a(){i.src({type:"video/youtube",src:e.value})}i.contextmenuUI({content:[{href:"https://cp.nnsvn.me/invite",label:"Invite Bot"}]}),i.mobileUi(),i.posterTime(),i.controlBar.addChild("QualitySelector"),document.getElementById("youtubeplayerbtn").addEventListener("click",()=>{a()}),e.addEventListener("keyup",function(e){"Enter"===e.key&&(e.preventDefault(),a())}),s.setAttribute("data-loaded","true")})})})();