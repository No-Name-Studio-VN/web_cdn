(()=>{window.AnimateBackground({light:"repeating-linear-gradient(45deg, #92c9b1, #92c9b1 20px, #b3e0d2 20px, #b3e0d2 40px)",dark:"repeating-linear-gradient(45deg, #92c9b1, #92c9b1 20px, #b3e0d2 20px, #b3e0d2 40px)",duration:"30s"});const s=$("#lyrics-content").find(".simplebar-content");let t=0,i=!1,a=!1;function r(e){e.empty().append($("<h1>").addClass("my-3").text("🎵⛔ Lyric is unavailable for this song. 🎵⛔"))}const l=document.querySelector("#videobg"),o=l.querySelector("source"),n=client.cdn+"/static/media/video/bg/",c=["frierendance.webm","stelle.webm","frierenvibe.webm","chottomate.webm","1.webm","2.webm"];function d(){var e=$(".current");if(!e?.length)return logger.error("No current lyric found");e[0].scrollIntoView({behavior:"smooth",block:"center",inline:"center"})}function p(t){var i=document.querySelectorAll(".song-name");for(let e=0;e<i.length;e++)i[e].textContent=t}function u(t){var i=document.querySelectorAll(".artist-name");for(let e=0;e<i.length;e++)i[e].textContent=t}function m(e){let t="";e?t+=e.map(e=>`<h2 class='my-3' data-timestamp='${e.time}'>${e.line}</h2>`).join(""):t="<h2 class='my-3'>Lyric is unavailable for this song.</h2>",s.html(t),s.find("h2").off("click").on("click",function(){var e=$(this).data("timestamp");e=e/1e3,$("#jplayer_N").jPlayer("play",e)})}async function y(e){var t,i=s.find("h2");i?.length&&(t=await i.filter(function(){return $(this).data("timestamp")<=e}).last(),i.removeClass("current"),t.addClass("current"))}function h(e){const s=[],a="https://spotify-lyrics-api.nnsvn.me/?url="+e;return new Promise((t,i)=>{$.ajax({url:a,type:"GET",success:async function(e){const a=e.lines;if(!a)throw new Error("No lyrics found");await a.map((e,t)=>{var i=parseInt(e.startTimeMs),t=(a[t+1]&&parseInt(a[t+1].startTimeMs),e.words);s.push({time:i,line:t})}),t(s)},error:function(e){i(e)}})})}$("#replacebg").on("click",function(){let e;for(;(e=n+c[Math.floor(Math.random()*c.length)])===o.getAttribute("src"););o.setAttribute("src",e),l.load(),l.play()});var e=window.UrlHandler.getQuery("guildId");if(e)$("#lyrics").css("height","70vh"),$.ajax({url:"/musicplayer/"+e,type:"GET",success:async function(e){const a=e.data;if(!Object.keys(a).length)return logger.error("No data found"),r(s);p(a.songDetails.name),u(a.songDetails.artists[0].name),await h(a.songDetails.external_urls.spotify).then(async e=>{if(e){await m(e);let t=moment(a.timeStarted);if(t.isValid()){const i=setInterval(()=>{var e=Date.now(),e=moment(e).diff(t,"seconds");y(1e3*(e+a.currentTime)),d(),e+a.currentTime>=a.songDetails.duration_ms/1e3&&clearInterval(i)},200)}s.find("h2").off("click").on("click",()=>{var e=$(this).data("timestamp")/1e3;t=moment(Date.now()).subtract(e,"seconds")})}}).catch(e=>{window.console.error(e),r(s)})},error:function(e){window.console.error(e),r(s)}});else if(window.UrlHandler.getQuery("musicplayer")){setInterval(()=>{i&&a&&d()},200);$("#player_container").append(`
    ...
    `),$("#search_lyrics_btn").on("click",async function(){var e,t=$("#search_lyrics").val();if(!t)return logger.error("No query provided");e=t,new Promise((t,i)=>{$.ajax({url:"/musicplayer/search",type:"POST",contentType:"application/json",data:JSON.stringify({query:e}),success:function(e){t(e)},error:function(e){i(e)}})}).then(async e=>{return e.error?logger.error(e.error):(e=e.track)?(p(e.name),u(e.artists[0].name),void await h(e.external_urls.spotify).then(async e=>{e&&await m(e)}).catch(e=>{window.console.error(e),r(s)})):logger.error("No track found")}).catch(e=>{window.console.error(e),r(s)})})}})();